@section('breadcrumb')
    <x-breadcrumb>
        <li class="breadcrumb-item"><a href="{{ route('admin.profile') }}">{{ trans('dashboard.profile.Profile') }}</a></li>
        <li class="breadcrumb-item active" aria-current="page"><a>{{ trans('dashboard.profile.My Profile') }}</a></li>
    </x-breadcrumb>
@endsection
